...
Encoder Block: The encoder is responsible for extracting features from the input image. it is the contraction path block containing two 3x3 convolutional layers with ReLU activations, followed by a 2x2 max pooling layer.
